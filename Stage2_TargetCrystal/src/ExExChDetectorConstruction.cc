...
fWorldLogic(0),fXtalLogic(0){
    ...
    fXtalSize = G4ThreeVector(constants::crystalWidth * CLHEP::millimeter,
                              constants::crystalHeight * CLHEP::millimeter,
                              constants::crystalLength * CLHEP::millimeter);
    fXtalCurvatureRadius = G4ThreeVector(constants::crystalRadius * CLHEP::meter,
                                         0. * CLHEP::meter,
                                         0. * CLHEP::meter);
...
G4VPhysicalVolume* ExExChDetectorConstruction::Construct(){
    //** World **//
    fWorldSize = G4ThreeVector(100. * CLHEP::millimeter,
                               100. * CLHEP::millimeter,
                               (constants::targetLength*2.0 +
                                constants::crystalLength +
                                constants::targetCrystalGap*4.0) * CLHEP::millimeter);
    ...
    G4Box* phantom_box = new G4Box("phantom",
                                   100. * CLHEP::millimeter/2,
                                   100. * CLHEP::millimeter/2,
                                   0.10 * CLHEP::millimeter/2);

    G4LogicalVolume* phantom_log_0 = new G4LogicalVolume(phantom_box,fWorldMaterial,"phantom_0");
    G4LogicalVolume* phantom_log_1 = new G4LogicalVolume(phantom_box,fWorldMaterial,"phantom_1");
    new G4PVPlacement(0,G4ThreeVector(0,0,
                                      (0.0 -
                                      constants::targetCrystalGap/2.0 -
                                      constants::crystalLength/2.0) * CLHEP::millimeter),phantom_log_0,"phantom_0",fWorldLogic,false,0);
    new G4PVPlacement(0,G4ThreeVector(0,0,
                                      (0.0 +
                                       constants::crystalLength/2.0 +
                                       constants::targetCrystalGap/2.0) * CLHEP::millimeter),phantom_log_1,"phantom_1",fWorldLogic,false,0);

    phantom_log_0->SetVisAttributes(G4VisAttributes(G4Color::Gray()));
    phantom_log_1->SetVisAttributes(G4VisAttributes(G4Color::Gray()));

    //** Tungsten Target **//
    G4Box* W_target_box = new G4Box("W_target",
                                    constants::targetWidth * CLHEP::millimeter/2,
                                    constants::targetHeight * CLHEP::millimeter/2,
                                    constants::targetLength * CLHEP::millimeter/2);

    G4Material* W_target_Material = G4NistManager::Instance()->FindOrBuildMaterial("G4_W");
    G4LogicalVolume* W_target_log = new G4LogicalVolume(W_target_box,W_target_Material,"W_target");
    /*new G4PVPlacement(0,G4ThreeVector(0,0, (0.0 -
                                            constants::targetLength/2.0 -
                                            constants::targetCrystalGap -
                                            constants::crystalLength/2.0)* CLHEP::millimeter),W_target_log,"W_target",fWorldLogic,false,0);*/

    W_target_log->SetVisAttributes(G4VisAttributes(G4Color::Brown()));
    ...
    if(fXtalCurvatureRadius.x() != 0.){
        ...
        fXtalPhysical =
            new G4PVPlacement(vRotationMatrix,
                              G4ThreeVector(-fXtalCurvatureRadius.x(),0.,-fXtalSize.z()/2.),
                              fXtalLogic,"Target",
                              fWorldLogic,
                              false,
                              0);
